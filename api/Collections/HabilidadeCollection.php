...
class HabilidadeCollection implements ICollection {
    ...
    private function getByObjetoConhecimento($objetoConhecimento, $status) {
        $sql = "SELECT * FROM " . self::_TABLE . " WHERE FIND_IN_SET(objeto_conhecimento_id, :objeto_conhecimento_id)";
    ...
    private function getByObjetoConhecimentoAndCompetencia($objetoConhecimento, $competencia, $status) {
        $sql = "SELECT * FROM " . self::_TABLE . " WHERE FIND_IN_SET(objeto_conhecimento_id, :objeto_conhecimento_id) AND FIND_IN_SET(competencia, :competencia)";
